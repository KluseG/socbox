...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid" id="mainWrapper">
      <div class="row">
		      <div class="col col-lg-4 shortcuts-col">
            ...
            <div class="col-12 shortcuts d-flex justify-content-center">
              <div class="shortcuts-wrapper">
                <a href="#"><i class="material-icons mr-3">people</i> Account</a>
              </div>
            </div>
          </div>
          <div class="col col-lg-4 feed-col">
            <form action="/avatar/change" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col">
