...
<html lang="en">
  ...
  <body>
          ...
          <div class="col d-lg-flex col-lg-4 justify-content-center">
            <form method="post" action="/search">
              <div class="input-group">
                <input type="text" class="form-control" id="search" name="string" placeholder="Search SocBox" value="{% value %}">
    ...
    <div class="container-fluid" id="mainWrapper">
      <div class="row">
        <div class="col col-lg-4 feed-col ml-auto mr-auto text-center">
          <?php if (!empty($results)) : ?>
            <?php foreach ($results as $result) : ?>
              <a href="/user/profile/<?=$result['uname']?>" style="padding: 15px;">
              <div class="media">
                <img class="d-flex align-self-center mr-3" src="/assets/img/<?=$result['avatar']?>" alt="Generic placeholder image"  style="border-radius: 50%; width: 64px;">
                <div class="media-body align-self-center">
                  <h6 class="mt-0"><?=$result['item']?></h6>
                </div>
              </div>
              </a>
            <?php endforeach; ?>
